...
namespace TARge20.Core.Domain
{
    public class Employee
    {
        ...
        public ICollection<PuhkuseTyyp> PuhkuseTyyp { get; set; }
        public ICollection<Haiguslehed> Haiguslehed { get; set; }
        public ICollection<HaigusleheTyyp> HaigusleheTyyp { get; set; }
        public ICollection<Töösuhe> Töösuhe { get; set; }
        public ICollection<Ligipääsuluba> Ligipääsuluba { get; set; }
        public ICollection<LigipääsuloaTyyp> LigipääsuloaTyyp { get; set; }
